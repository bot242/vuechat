  ...
  actions: {
    login({commit}, user){
        ...
        return new Promise((resolve, reject) => {
          commit('auth_request')
          axios({url: 'http://chatbotportal.herokuapp.com/api/api-token-auth/', data: user, method: 'POST' })
          .then(resp => {
    ...
    register({commit}, user){
        return new Promise((resolve, reject) => {
          commit('auth_request')
          axios({url: 'http://chatbotportal.herokuapp.com/api/user/', data: user, method: 'POST' })
          .then(resp => {
