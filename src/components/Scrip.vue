  ...
  this.axios
    ...
    faClass(icon) {
        ...
        // console.log("working success",bvModalEvt)
         this.axios.get('http://chatbotportal.herokuapp.com/api/script/'+this.currentdata.id+'/')
         .then(res=>{
          ...
          let obj=res.data 
           ...
           console.log(obj)
           //'http://chatbotportal.herokuapp.com/api/script/'+this.currentdata.id+'/' 
             let id=localStorage.getItem('id')
            let botid=localStorage.getItem("bot_id")
           this.axios.patch('http://chatbotportal.herokuapp.com/api/scriptdetails/'+id+'/'+botid+'/',obj)
         .then(res=>{
            console.log("success res ==>",res.data)
           this.axios.put('http://chatbotportal.herokuapp.com/api/subquestionadd/'+this.currentdata.id+'/',obj)
             .then(item =>{
...
this.$root.$emit('bv::hide::modal', 'modal-1', '#btnShow') 
          ...
          deletedata(id){
              ...
              this.axios.delete('http://chatbotportal.herokuapp.com/api/script/'+id+"/")
              .then(res=>{
